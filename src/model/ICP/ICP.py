...
if __name__ == "__main__":
    ...
    transformation_matrix[:3, :3] = R_true
    transformation_matrix[:3, 3] = t_true
    # apply transformation matrix
    B = A @ transformation_matrix[:3, :3].T + transformation_matrix[:3, 3].T

    # Perform ICP
    T, distances, i = icp(A, B, max_iterations=200)
    ...
    print('Mean distance to closest point:', np.mean(distances))
